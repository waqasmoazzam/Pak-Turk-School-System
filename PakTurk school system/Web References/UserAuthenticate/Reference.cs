...
namespace PakTurk_school_system.UserAuthenticate {
    ...
    public partial class LoginWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public LoginWebService() {
            this.Url = global::PakTurk_school_system.Properties.Settings.Default.PakTurk_school_system_UserAuthenticate_LoginWebService;
        ...
        /// <remarks/>
        public void loginServiceAsync(string txtUsername, string txtPassword) {
            this.loginServiceAsync(txtUsername, txtPassword, null);
        }
        
        /// <remarks/>
        public void loginServiceAsync(string txtUsername, string txtPassword, object userState) {
            ...
            this.InvokeAsync("loginService", new object[] {
                        txtUsername,
                        txtPassword}, this.loginServiceOperationCompleted, userState);
        }
