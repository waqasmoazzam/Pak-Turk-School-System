...
namespace PakTurk_school_system.School_SystemDataSetTableAdapters {
    ...
    public partial class CityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT     ci.CityName\r\nFROM         City AS ci INNER JOIN\r\n                     " +
        ...
        public virtual int Fill(School_SystemDataSet.CityDataTable dataTable) {
        ...
        public virtual School_SystemDataSet.CityDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            School_SystemDataSet.CityDataTable dataTable = new School_SystemDataSet.CityDataTable();
        ...
        public virtual int citybound(School_SystemDataSet.CityDataTable dataTable) {
